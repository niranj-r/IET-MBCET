        ...
        <div className="flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center gap-3 group">
            <div className="w-12 h-12 bg-primary flex items-center justify-center">
              <span className="text-primary-foreground font-display font-bold text-xl">IET</span>
            </div>
            <div className="hidden md:block">
              <div className="font-display font-bold text-xl text-primary leading-none">IET MBCET</div>
              <div className="microtext text-foreground/60 mt-1">Engineering Excellence</div>
            </div>
          </Link>
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            >
              <Link
                ...
                className={`font-body font-medium transition-smooth relative ${
                  location.pathname.startsWith('/events') ? "text-primary" : "text-foreground hover:text-primary"
                }`}
              >
                Events
              ...
              <div className="border-t border-primary/20 pt-4">
                ...
                {years.map((year) => (
                  <Link
                    ...
                    to={`/events/${year}`}
                    onClick={() => setIsOpen(false)}
                    className={`block font-body font-medium py-2 transition-smooth ${
                      location.pathname === `/events/${year}` ? "text-primary" : "text-foreground"
                    }`}
                  >
                    {year}
                  </Link>
